...
import "./styles.css";
import { alterarSenhaProfissionalPorEmail } from "../../../services/alterarSenha.service";
...
export default function AlterarSenhaProfissional() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      await alterarSenhaProfissionalPorEmail(email, data.novaSenha);
      Swal.fire({
        title: "Sucesso!",
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => navigate("/profissional/otp")}
      >
