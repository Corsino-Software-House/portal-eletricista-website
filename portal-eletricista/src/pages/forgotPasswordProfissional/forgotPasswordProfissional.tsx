...
export default function ForgotPasswordProfissional() {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      // redireciona para a tela de OTP, passando o email
      navigate("/profissional/otp", { state: { email: data.email } });
    } catch (err: any) {
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => navigate("/areadoprofissional")}
      >
