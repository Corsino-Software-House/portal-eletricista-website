    ...
    <>
       <section className="depoimentos">
          ...
          <div className="cards">
            ...
            <div className="card">
              <img src="\public\img\client.svg" alt="Reviewer name"></img>
              <h3>Reviewer name</h3>
        ...
        <section className="depoimentos">
          ...
          <div className="cards">
            ...
            <div className="card">
              <img src="\public\img\casemiro.svg" alt="Reviewer name"></img>
              <h3>Casemiro</h3>
              ⭐ ⭐ ⭐ ⭐ ⭐
            </div>

            <div className="card">
              <img src="\public\img\felipe.svg" alt="Reviewer name"></img>
              <h3>Felipe</h3>  
              ⭐ ⭐ ⭐ ⭐ ⭐              
            </div>
             
            <div className="card">
              <img src="\public\img\rodrigo.svg" alt="Reviewer name"></img>
