...
const BookingForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const match = todasEspecialidades.find(
      (opt) => normalizar(opt) === normalizar(tituloProjeto)
    );
        ...
        <form className="booking-form" onSubmit={handleSubmit}>
          ...
          <label>
            ...
            >
              ...
              <optgroup label="Elétrica">
                ...
                <option value="Tomadas e interruptores (instalação, substituição, reparo)">
                  Tomadas e interruptores (instalação, substituição, reparo)
                </option>
                <option value="Iluminação interior e exterior (convencional e LED)">
                  Iluminação interior e exterior (convencional e LED)
                </option>
                ...
                <option value="Aumento de potência de quadro elétrico, ficha eletrotécnica e padrão E-redes">
                  Aumento de potência de quadro elétrico, ficha eletrotécnica e
                  padrão E-redes
                </option>
                <option value="Certificação elétrica (para venda ou arrendamento de imóveis)">
                  Certificação elétrica (para venda ou arrendamento de imóveis)
                </option>
                <option value="Inspeções técnicas e diagnósticos de falhas">
                  Inspeções técnicas e diagnósticos de falhas
                </option>
              </optgroup>
              <optgroup label="Domótica / Smart Home">
                <option value="Instalação e configuração de assistentes virtuais (Alexa, Google Home, etc.)">
                  Instalação e configuração de assistentes virtuais (Alexa,
                  Google Home, etc.)
                </option>
                <option value="Instalação de tomadas e interruptores inteligentes (Wi-Fi)">
                  Instalação de tomadas e interruptores inteligentes (Wi-Fi)
                </option>
                <option value="Automatização de iluminação, estores e persianas">
                  Automatização de iluminação, estores e persianas
                </option>
                <option value="Instalação de câmeras de vigilância (CCTV)">
                  Instalação de câmeras de vigilância (CCTV)
                </option>
                <option value="Instalação de sensores de movimento, fumaça, gás e inundação">
                  Instalação de sensores de movimento, fumaça, gás e inundação
                </option>
                <option value="Controlo remoto de dispositivos via app">
                  Controlo remoto de dispositivos via app
                </option>
                <option value="Integração de sistemas de segurança com domótica">
                  Integração de sistemas de segurança com domótica
                </option>
                <option value="Consultoria e otimização do consumo elétrico com smart meters">
                  Consultoria e otimização do consumo elétrico com smart meters
                </option>
              </optgroup>
              <optgroup label="Hidráulica / Canalização">
                <option value="Reparação de fugas de água (canos, torneiras, sifões)">
                  Reparação de fugas de água (canos, torneiras, sifões)
                </option>
                <option value="Desentupimentos (sanitas, lavatórios, ralos, canos)">
                  Desentupimentos (sanitas, lavatórios, ralos, canos)
                </option>
                <option value="Instalação de torneiras, chuveiros e misturadoras">
                  Instalação de torneiras, chuveiros e misturadoras
                </option>
                <option value="Substituição de loiças sanitárias (sanitas, bidês, lavatórios)">
                  Substituição de loiças sanitárias (sanitas, bidês, lavatórios)
                </option>
                <option value="Instalação de máquinas de lavar roupa/loiça">
                  Instalação de máquinas de lavar roupa/loiça
                </option>
                <option value="Reparação e substituição de autoclismos">
                  Reparação e substituição de autoclismos
                </option>
                <option value="Montagem de sistemas de filtragem e purificação de água">
                  Montagem de sistemas de filtragem e purificação de água
                </option>
                <option value="Canalizações completas para obras novas ou remodelações">
                  Canalizações completas para obras novas ou remodelações
                </option>
                <option value="Verificação e substituição de esgotos e águas pluviais">
                  Verificação e substituição de esgotos e águas pluviais
                </option>
                <option value="Certificações e ensaios de pressão/estanqueidade">
                  Certificações e ensaios de pressão/estanqueidade
                </option>
              </optgroup>
              <optgroup label="Serviços Gerais e Emergência">
                <option value="Reparos elétricos e hidráulicos simples">
                  Reparos elétricos e hidráulicos simples
                </option>
                <option value="Manutenção periódica de sistemas">
                  Manutenção periódica de sistemas
                </option>
                <option value="Pequenas remodelações de cozinha e WC (ligadas a elétrica e canalização)">
                  Pequenas remodelações de cozinha e WC (ligadas a elétrica e
                  canalização)
                </option>
                <option value="Instalação de suportes de TV, luminárias, cortinados">
                  Instalação de suportes de TV, luminárias, cortinados
                </option>
                <option value="Substituição de tomadas e interruptores danificados">
                  Substituição de tomadas e interruptores danificados
                </option>
                <option value="Falta de energia elétrica">
                  Falta de energia elétrica
                </option>
                <option value="Quadro a disparar / disjuntor queimado">
                  Quadro a disparar / disjuntor queimado
                </option>
                <option value="Fugas de água visíveis ou risco de inundação">
                  Fugas de água visíveis ou risco de inundação
                </option>
                <option value="Entupimentos graves">Entupimentos graves</option>
                <option value="Problemas com aquecedores elétricos ou termoacumuladores">
                  Problemas com aquecedores elétricos ou termoacumuladores
                </option>
              </optgroup>
            </select>
          ...
          <label>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Telefone, email ou outro meio de contato"
              required
            />
          </label>
