...
export default function Chamados() {
  ...
  function handleSolicitarChamado() {
        ...
        <div className="chamado__container">
          <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao1" selected>Selecione uma opção</option>
                <option value="instalacao"> Instalação elétrica completa (obra nova ou remodelação)</option>
                <option value="substituicao">Substituição de quadros elétricos</option>
                <option value="disjuntores">Instalação de disjuntores e diferencial</option>
                <option value="passagem">Passagem e substituição de cabos</option>
                <option value="tomadas">Tomadas e interruptores (instalação, substituição, reparo)</option>
          ...
          <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao2" selected>Selecione uma opção</option>
                <option value="instalacao">Instalação e configuração de assistentes virtuais (Alexa, Google Home, etc.)</option>
                <option value="wifi">Instalação de tomadas e interruptores inteligentes (Wi-Fi)</option>
                <option value="automatizacao">Automatização de iluminação, estores e persianas</option>
                <option value="cameras">Instalação de câmeras de vigilância (CCTV)</option>
                <option value="sensores">Instalação de sensores de movimento, fumaça, gás e inundação</option>
                <option value="controlo">Controlo remoto de dispositivos via app</option>
                <option value="sistemas">Integração de sistemas de segurança com domótica</option>
          ...
          <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao3" selected>Selecione uma opção</option>
                <option value="reparacao">Reparação de fugas de água (canos, torneiras, sifões)</option>
                <option value="desentupimento">Desentupimentos (sanitas, lavatórios, ralos, canos)</option>
                <option value="instalacao">Instalação de torneiras, chuveiros e misturadoras</option>
                <option value="substituicao">Substituição de loiças sanitárias (sanitas, bidês, lavatórios)</option>
                <option value="maquinas">Instalação de máquinas de lavar roupa/loiça</option>
                <option value="autoclismos">Reparação e substituição de autoclismos</option>
                <option value="montagem">Montagem de sistemas de filtragem e purificação de água</option>
                <option value="canalizacoes">Canalizações completas para obras novas ou remodelações</option>
                <option value="verificacao">Verificação e substituição de esgotos e águas pluviais</option>
           ...
           <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao4" selected>Selecione uma opção</option>
                <option value="reparos">Reparos elétricos e hidráulicos simples</option>
                <option value="sistemas">Manutenção periódica de sistemas</option>
                <option value="remodelacoes">Pequenas remodelações de cozinha e WC (ligadas a elétrica e canalização)</option>
                <option value="cortinados">Instalação de suportes de TV, luminárias, cortinados</option>
          ...
          <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao5" selected>Selecione uma opção</option>
                <option value="energia">Falta de energia elétrica</option>
                <option value="quadro">Quadro a disparar / disjuntor queimado</option>
                <option value="inundacao">Fugas de água visíveis ou risco de inundação</option>
          ...
          <div className="chamado__item">
            ...
            <div className="chamado__texto">
              ...
              <select className="chamado__select">
                <option value="opcao6" selected>Selecione uma opção</option>
                <option value="filtrados">Receba pedidos filtrados por zona, tipo de serviço e urgência</option>
                <option value="pagamento">Pagamento seguro e garantido pela plataforma</option>
                <option value="flexibilidade">Flexibilidade de horários e aceitação de serviços</option>
                <option value="perfil">Acesso a cliente final com perfil validado</option>
